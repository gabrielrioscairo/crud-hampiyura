<%-- 
    Document   : socios
    Created on : May 30, 2019, 12:29:11 PM
    Author     : Gabriel
--%>
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-6 offset-md-6 text-center text-md-right">
                                    <h1>Mantenimiento de BD medicamentos</h1>
                                    <div class="mantenimiento">
                                        <a href="mostrartodos1.jsp" class="btn btn-hy">Mostrar todos los medimentos (en lista)</a> 
                                    </div>
                                    <div class="mantenimiento">
                                        <a href="mostrartodos2.jsp" class="btn btn-hy">Mostrar todos los medicamentos (en tabla)</a>
                                    </div><div class="mantenimiento">
                                        <a href="insertar.jsp" class="btn btn-hy">Insertar medicamento nuevo</a>
                                    </div><div class="mantenimiento">
                                        <a href="editar.jsp" class="btn btn-hy">Actualizar/Eliminar un medicamento</a>
                                    </div>
