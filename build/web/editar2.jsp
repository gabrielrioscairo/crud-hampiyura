<%-- 
    Document   : editar2
    Created on : 25/09/2018, 06:04:49 PM
    Author     : ricar
--%>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 offset-md-6 text-center text-md-right">
                                    ...
                                    <%
                                        ...
                                        rs = consulta.actualizar_obtener_datos(idurl);
                                        while (rs.next()) {
                                    %>
                                    <form action="editar" method="POST" >
                                        Ingrese id del medicamento: <INPUT type="text"  name="id" value="<%=rs.getInt("idmedic")%>" >
                                        <br><br>
                                        Ingrese nombre del medicamento: <INPUT type="text" value="<%=rs.getString("nombre")%>" name="nombre">
                                        <br><br>
                                        Ingrese marca del medicamento: <INPUT type="text" value="<%=rs.getString("marca")%>" name="marca">
                                        <br><br>
                                        Ingrese sintoma del cliente: <INPUT type="text" value="<%=rs.getString("sintomas")%>" name="sintomas">
                                        <br><br>
                                        Ingrese el stock del producto: <INPUT type="text" value="<%=rs.getInt("stock")%>" name="stock">
                                        <br><br>
                                        Ingrese la descripcion del producto: <textarea name="desc" cols="50" rows="5" ><%=rs.getString("descripcion")%></textarea>
                                        <br><br>
                                        Ingrese precio del medicamento: <INPUT type="text" value="<%=rs.getDouble("precio")%>" name="precio">
                                        <%}%>
                                        <p>
