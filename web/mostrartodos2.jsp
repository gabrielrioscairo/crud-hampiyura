<%-- 
    Document   : mostrartodos2
    Created on : 24/09/2018, 07:41:59 PM
                        ...
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-6 offset-md-6 text-center text-md-right">
                                    <h2>** Mostrar todos los medicamentos (en tabla) **</h2>
                                    <a href="todos2">Click para ver todos los medicamentos</a>
                                    <p>
                                        <br><br>
