<%-- 
    Document   : insertar
    Created on : 24/09/2018, 07:54:21 PM
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 offset-md-6 text-center text-md-right">
                                    ...
                                    <form action="insertar" method="POST">
                                        Ingrese id del medicamento: <INPUT type="text"  name="id"  >
                                        <br><br>
                                        Ingrese nombre del medicamento: <INPUT type="text"  name="nombre">
                                        <br><br>
                                        Ingrese marca del medicamento: <INPUT type="text" name="marca">
                                        <br><br>
                                        Ingrese sintoma del cliente: <INPUT type="text"  name="sintomas">
                                        <br><br>
                                        Ingrese el stock del producto: <INPUT type="text"  name="stock">
                                        <br><br>
                                        Ingrese la descripcion del producto: <textarea name="desc" cols="50" rows="5" >Descripcion</textarea>
                                        <br><br>
                                        Ingrese precio del medicamento: <INPUT type="text"  name="precio">
                                        <p>
