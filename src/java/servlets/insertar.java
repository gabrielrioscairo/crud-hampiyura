...
public class insertar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean resultado;
            resultado=consulta.insertar2_BD(Integer.parseInt(request.getParameter("id")),
            ...
            out.println("<h3>El medicamento " + request.getParameter("nombre") + 
                            " se ingreso correctamente </h3>");
            out.println("<input type=\"button\" value=\"Volver\" onclick=\"location.href='index.jsp'\">");
            }
            else
            {
                out.println("<h3>Error!!! Al INGRESAR el medicamento "+
                            request.getParameter("nombre")+"</h3>");
            out.println("<input type=\"button\" value=\"Volver\" onclick=\"location.href='index.jsp'\">");
            out.println("</body>");
            out.println("</html>");
        }
